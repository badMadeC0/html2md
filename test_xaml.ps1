...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <Grid Grid.Row="2">
            ...
            <Label Content="O_utput:" Target="{Binding ElementName=OutBox}" FontSize="14" VerticalAlignment="Center" Padding="0,0,5,0"/>
            <TextBox Name="OutBox" Grid.Column="1" FontSize="14" AutomationProperties.Name="Output Directory" ToolTip="Directory where files will be saved" VerticalAlignment="Center" Height="26"/>
