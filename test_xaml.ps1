...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <Grid Grid.Row="2">
            ...
            <TextBox Name="OutBox" Grid.Column="1" FontSize="14" VerticalAlignment="Center" Height="28" ToolTip="Directory where files will be saved"/>
...
# Just exit since we are running in headless CI without a display.
