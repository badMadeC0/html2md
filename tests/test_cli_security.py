...
class TestSecurityFix(unittest.TestCase):
    ...
    def test_http_url_blocked(self):
        ...
        self.assertTrue(
            any("Unsupported URL scheme" in o for o in cm.output),
            f"Expected 'Unsupported URL scheme' in logs, got: {cm.output}",
        )
    ...
    def test_ftp_url_blocked(self):
        ...
        self.assertTrue(any("Unsupported URL scheme" in o for o in cm.output))
        self.mock_session.get.assert_not_called()
