...
def test_cli_conversion_request_failure(capsys, caplog):
    ...
    # Setup RequestException
    MockRequestException = setup_mocks(mock_requests)
...
def test_cli_conversion_markdownify_failure(capsys, caplog):
    ...
    # Setup RequestException even if not raised, to allow 'except requests.RequestException' to work
    setup_mocks(mock_requests)
