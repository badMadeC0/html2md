...
def test_cli_conversion_request_failure(caplog):
    """Test that requests.get failure is caught and logged."""
...
def test_cli_conversion_markdownify_failure(caplog):
    """Test that markdownify failure is caught and logged."""
