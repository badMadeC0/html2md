...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <Grid Grid.Row="0">
            ...
            <Label Grid.Column="0" Content="_Paste URL(s):" Target="{Binding ElementName=UrlBox}" FontSize="14" VerticalAlignment="Center"/>
            <Button Name="ClearBtn" Grid.Column="1" Content="C_lear" Width="60" Height="22" Margin="5,0,0,0" VerticalAlignment="Center" ToolTip="Clear URL input"/>
        </Grid>
