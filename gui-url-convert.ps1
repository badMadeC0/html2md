...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <TextBox Name="UrlBox" Grid.Row="1" FontSize="14" Margin="0,5,0,10" AcceptsReturn="True"
                 ...
                 ToolTip="Enter one or more URLs (one per line)" AutomationProperties.Name="Enter URLs here"/>

        <StackPanel Grid.Row="2" Orientation="Vertical">
            <Label Content="Output _Directory:" Target="{Binding ElementName=OutBox}" FontSize="14" Padding="0,0,0,2"/>
            <StackPanel Orientation="Horizontal">
                <TextBox Name="OutBox" Width="340" FontSize="14" ToolTip="Directory where files will be saved" AutomationProperties.Name="Select Output Directory"/>
...
$ConvertBtn.Add_Click({
    ...
    try {
        ...
        $StatusText.Text = "Error: Please enter a valid HTTP/HTTPS URL."
        $StatusText.Foreground = "Red"
    ...
    if ($outdir -match '[&|;<>^"]' -or $outdir -match '%') {
        $StatusText.Text = "Security Warning: Invalid characters detected in output directory."
        $StatusText.Foreground = "Red"
        $ProgressBar.IsIndeterminate = $false
        return
    }
