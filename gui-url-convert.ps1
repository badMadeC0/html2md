...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <StackPanel Grid.Row="2" Orientation="Horizontal">
            <Label Content="_Output Directory:" Target="{Binding ElementName=OutBox}" FontSize="14" VerticalAlignment="Center" Margin="0,0,5,0"/>
            <TextBox Name="OutBox" Width="215" FontSize="14" AutomationProperties.Name="Output Directory" ToolTip="Directory where files will be saved" VerticalAlignment="Center" Height="26"/>
