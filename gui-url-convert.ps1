...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="10">
        ...
        <TextBox Name="UrlBox" Grid.Row="1" FontSize="14" Margin="0,5,0,10" AcceptsReturn="True"
                 ...
                 ToolTip="Enter one or more URLs (one per line)" AutomationProperties.Name="Enter URL(s)" Padding="4"/>

        <StackPanel Grid.Row="2" Orientation="Vertical">
            <Label Content="Output _Directory:" Target="{Binding ElementName=OutBox}" FontSize="14" Padding="0,0,0,2"/>
            <StackPanel Orientation="Horizontal">
                <TextBox Name="OutBox" Width="340" FontSize="14" ToolTip="Directory where files will be saved" AutomationProperties.Name="Output Directory" Padding="4"/>
        ...
        <CheckBox Name="WholePageChk" Grid.Row="3" Content="Convert _Whole Page"
                  ...
                  ToolTip="If checked, includes headers and footers. Default is main content only." Cursor="Hand"/>

        <Button Name="ConvertBtn" Grid.Row="3" Content="_Convert (All Formats)"
                Height="35" HorizontalAlignment="Right" Width="180" Margin="0,15,0,0"
                IsEnabled="False"
                ToolTip="Please enter at least one URL to enable conversion" Cursor="Hand"
                />
