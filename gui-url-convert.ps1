    ...
    <Grid Margin="10">
        ...
        <Grid>
            ...
            <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Bottom" Margin="0,0,0,2">
                <Button Name="PasteBtn" Content="Pas_te" Height="22" Width="60" Margin="0,0,5,0" ToolTip="Paste from Clipboard" AutomationProperties.Name="Paste from Clipboard"/>
                <Button Name="ClearBtn" Content="Clea_r" Height="22" Width="60" ToolTip="Clear URL list" AutomationProperties.Name="Clear URL List"/>
            </StackPanel>
        </Grid>
        ...
        <TextBox Name="UrlBox" Grid.Row="1" FontSize="14" Margin="0,5,0,10" AcceptsReturn="True"
                 ...
                 ToolTip="Enter one or more URLs (one per line)" AutomationProperties.Name="URL Input"/>
        ...
        <StackPanel Grid.Row="2" Orientation="Vertical">
            ...
            <StackPanel Orientation="Horizontal">
                ...
                <Button Name="BrowseBtn" Width="90" Height="28" Margin="10,0,0,0" ToolTip="Select output folder" AutomationProperties.Name="Browse Output Directory">_Browse...</Button>
                <Button Name="OpenFolderBtn" Width="90" Height="28" Margin="10,0,0,0" ToolTip="Open output folder" AutomationProperties.Name="Open Output Folder">_Open Folder</Button>
            </StackPanel>
        </StackPanel>
        ...
        <Button Name="ConvertBtn" Grid.Row="3" Content="_Convert (All Formats)"
                ...
                AutomationProperties.Name="Convert URLs to All Formats"
                />
