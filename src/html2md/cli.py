...
def process_url(target_url: str, args: argparse.Namespace, session: Any) -> None:  # pylint: disable=too-many-locals
...
def main(argv=None):
    ...
    if args.url or args.batch:
        ...
        if args.url:
            process_url(args.url, args, session)
