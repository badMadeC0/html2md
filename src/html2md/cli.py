...
def is_safe_path(basedir: str, target: str) -> bool:
    """
    Verify that the target path is safely within the basedir.
    Prevents directory traversal and prefix-collision attacks.
    """
    try:
        ...
        def process_url(target_url: str) -> None:
            ...
            try:
                ...
                if args.outdir:
                    ...
                    if not is_safe_path(args.outdir, out_path):
                        print(
