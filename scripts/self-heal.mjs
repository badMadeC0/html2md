...
if (fixed) {
  console.log("Self-heal completed successfully with changes.");
  process.exit(0);
} else {
  console.log("Self-heal completed, but no changes were made or healthcheck still fails.");
  process.exit(passHealth() ? 0 : 1);
}
