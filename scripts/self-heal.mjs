...
// Exit correctly based on whether we were able to fix the issue and generate a diff
if (fixed && passHealth()) {
  console.log("Self-heal successful and produced changes.");
  process.exit(0);
} else {
  console.log("Self-heal either failed or did not produce necessary changes.");
  process.exit(1);
}
